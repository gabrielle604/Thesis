...
model_adult_noED <- svyglm(log(monoEthyl)~refED+age+gender+ethnicity+fpl+citizenship, design=subset_adult, na.action = na.omit)
...
forest_adult <- plot_summs(
        ...
        model_adult, coefs = c("Household Education Partial College and Below
...
model_child <- svyglm(log(monoEthyl)~refED+age+gender+ethnicity+fpl+citizenship, design=subset_child, na.action = na.omit)
