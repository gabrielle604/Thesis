...
### this actually won't work with the re-categorized data -- have to use the original variables
## Complete an analysis:
Since there are 30 variables, we will select only the variables we will use in this analysis
