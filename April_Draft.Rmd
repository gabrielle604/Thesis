...
svyboxplot(~log(monoEthyl)~factor(ethnicity), subset_child, xlab = "Race/Ethnicity", main = "Bivariate Analysis of (Logged) Urinary Mono-ethyl Phthalate and Race/Ethnicity")
...
## Interactions ??? [possibly to work on later, but prioritize other revisions]
interact1: race/ethnicity and HHH education [children]
interact2: race/ethnicity and participant education [adults]
interact3: gender and ?
